...
import '../../../widgets/vehicle_widgets/specific_vehicle_widgets/assigned_trips_tbl.dart';
import '../../../widgets/vehicle_widgets/specific_vehicle_widgets/vehicle_dashboard.dart';
import '../../../widgets/vehicle_widgets/specific_vehicle_widgets/vehicle_tags_table.dart';
...
class _SpecificVehicleViewState extends State<SpecificVehicleView>
  ...
  final int _assignedTotalPages = 1;
  ...
  // Pagination / search for the vehicle tags table
  int _tagsCurrentPage = 1;
  final int _tagsTotalPages = 1;
  final TextEditingController _tagsSearchController = TextEditingController();
  String _tagsSearchQuery = '';
  ...
  void _loadAll() {
    ...
    // Request delivery vehicle info by id (this also loads the
    // vehicleTags relation via the datasource expansion).
                    ...
                    delegate: SliverChildListDelegate([
                      ...
                      BlocBuilder<DeliveryVehicleBloc, DeliveryVehicleState>(
                        builder: (context, state) {
                          ...
                          DeliveryVehicleEntity? vehicleEntity;
                          if (state is DeliveryVehicleLoaded) {
                      ...
                      // Vehicle Tags table - uses DeliveryVehicleBloc
                      VehicleTagsTable(
                        deliveryVehicleDataId: widget.vehicleId,
                        currentPage: _tagsCurrentPage,
                        totalPages: _tagsTotalPages,
                        onPageChanged: (page) {
                          setState(() => _tagsCurrentPage = page);
                        },
                        searchController: _tagsSearchController,
                        searchQuery: _tagsSearchQuery,
                        onSearchChanged: (q) {
                          setState(() {
                            _tagsSearchQuery = q;
                            _tagsCurrentPage = 1;
