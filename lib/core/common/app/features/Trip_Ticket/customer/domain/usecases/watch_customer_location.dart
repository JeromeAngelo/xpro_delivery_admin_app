...
class WatchCustomerLocation {
  const WatchCustomerLocation(this._repo);
  final CustomerRepo _repo;

  Stream<Either<Failure, CustomerEntity>> call(String customerId) => 
      _repo.watchCustomerLocation(customerId);
}
