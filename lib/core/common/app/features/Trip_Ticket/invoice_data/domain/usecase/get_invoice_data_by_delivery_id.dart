...
class GetInvoiceDataByDeliveryId extends UsecaseWithParams<List<InvoiceDataEntity>, String> {
  const GetInvoiceDataByDeliveryId(this._repo);

  final InvoiceDataRepo _repo;

  @override
  ResultFuture<List<InvoiceDataEntity>> call(String params) async {
    return _repo.getInvoiceDataByDeliveryId(params);
  }
}
