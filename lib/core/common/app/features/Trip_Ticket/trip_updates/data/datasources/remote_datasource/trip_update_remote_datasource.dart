...
// New function implementations
  ...
  Future<TripUpdateModel> updateTripUpdate({
    ...
    try {
      ...
      final updatedRecord = await _pocketBaseClient.collection('trip_updates').update(
        updateId,
        body: body,
      ...
      final record = await _pocketBaseClient.collection('trip_updates').getOne(
        updateId,
        expand: 'trip',
      );
  ...
  Future<bool> deleteTripUpdate(String updateId) async {
    try {
      ...
      final record = await _pocketBaseClient.collection('trip_updates').getOne(updateId);
