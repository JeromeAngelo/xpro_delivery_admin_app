...
class GetAllUnassignedInvoices extends UsecaseWithoutParams<List<InvoicePresetGroupEntity>> {
  const GetAllUnassignedInvoices(this._repo);

  final InvoicePresetGroupRepo _repo;

  @override
  ResultFuture<List<InvoicePresetGroupEntity>> call() async {
    return _repo.getAllUnassignedInvoicePresetGroups();
  }
}
