...
class TripCoordinatesModel extends TripCoordinatesEntity {
  ...
  factory TripCoordinatesModel.fromJson(Map<String, dynamic> json) {
    ...
    return TripCoordinatesModel(
      ...
      deviceBatteryLife: json['deviceBatteryLife'] != null ? double.parse(json['deviceBatteryLife'].toString()) : null,
      networkSpeed: json['networkSpeed'] != null ? double.parse(json['networkSpeed'].toString()) : null,
  ...
  DataMap toJson() {
    return {
      ...
      'deviceBatteryLife': deviceBatteryLife?.toString(),
  ...
  TripCoordinatesModel copyWith({
    ...
    return TripCoordinatesModel(
      ...
      deviceBatteryLife: deviceBatteryLife ?? this.deviceBatteryLife,
