...
class CreateDeliveryVehicle
    extends UsecaseWithParams<DeliveryVehicleEntity, DeliveryVehicleEntity> {
  final DeliveryVehicleRepo _repo;

  const CreateDeliveryVehicle(this._repo);

  @override
  ResultFuture<DeliveryVehicleEntity> call(DeliveryVehicleEntity params) {
    return _repo.createDeliveryVehicle(params);
  }
}
