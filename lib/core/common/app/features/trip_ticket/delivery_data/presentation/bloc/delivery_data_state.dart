...
class SearchingDeliveryData extends DeliveryDataState {
  const SearchingDeliveryData();

  @override
  List<Object?> get props => [];
}

class SearchDeliveryDataLoaded extends DeliveryDataState {
  final List<DeliveryDataEntity> results;
  final String query;

  const SearchDeliveryDataLoaded({
